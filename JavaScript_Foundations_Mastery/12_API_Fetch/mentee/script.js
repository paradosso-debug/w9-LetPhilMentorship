...
adviceBtn.addEventListener("click", () => {
  ...
  fetch("https://api.adviceslip.com/advice")
    ...
    .catch((error) => {
      console.error(error);
      adviceText.textContent = "Could not load Random Advice, try again later.";
    });
});
// ==============================================
  ...
  fetch("https://catfact.ninja/fact")
    ...
    .catch((error) => {
      ...
      catFactText.textContent =
        "Could not load any cat facts. Try again later...";
    });
});
...
spaceBtn.addEventListener("click", () => {
  ...
  fetch(apiUrl)
    .then((response) => {
      if (!response.ok) {
        throw new Error("NASA video/picture failed");
      }
      return response.json();
    })
    .then((data) => {
